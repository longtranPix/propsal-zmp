            ...
            <div className="timeline-container relative h-full">
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <div className="phase-pill bg-blue-100 text-blue-700">Giai đoạn 1 • Tuần 1-2</div>
              ...
              <div className="timeline-item">
                <div className="timeline-point"></div>
                <div className="timeline-content">
                  <div className="phase-pill bg-cyan-100 text-cyan-700">Giai đoạn 2 • Tuần 3-4</div>
                  <h3 className="text-lg font-bold text-gray-800 mb-2 flex items-center">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li className="flex items-center">
                      <i className="fas fa-circle text-xs text-cyan-500 mr-2"></i> Cài đặt Mini App trên hệ thống Zalo
                    </li>
                    <li className="flex items-center">
                      <i className="fas fa-circle text-xs text-cyan-500 mr-2"></i> Tích hợp với phần mềm nha khoa hiện
                      tại
                    </li>
                    <li className="flex items-center">
                      <i className="fas fa-circle text-xs text-cyan-500 mr-2"></i> Thiết lập hệ thống thông báo
                    </li>
                    <li className="flex items-center">
                      <i className="fas fa-circle text-xs text-cyan-500 mr-2"></i> Cấu hình bảo mật dữ liệu
                    </li>
                  </ul>
                  <div className="mt-3 bg-cyan-50 p-2 rounded-lg text-xs text-cyan-700">
              ...
              <div className="timeline-item">
                <div className="timeline-point"></div>
                <div className="timeline-content">
                  <div className="phase-pill bg-green-100 text-green-700">Giai đoạn 3 • Tuần 5</div>
                  <h3 className="text-lg font-bold text-gray-800 mb-2 flex items-center">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li className="flex items-center">
                      <i className="fas fa-circle text-xs text-green-500 mr-2"></i> Đào tạo đội ngũ lễ tân & quản lý
                    </li>
                    <li className="flex items-center">
                      <i className="fas fa-circle text-xs text-green-500 mr-2"></i> Hướng dẫn bác sĩ sử dụng hệ thống
                    </li>
                    <li className="flex items-center">
                      <i className="fas fa-circle text-xs text-green-500 mr-2"></i> Tạo tài liệu hướng dẫn sử dụng
                    </li>
                    <li className="flex items-center">
                      <i className="fas fa-circle text-xs text-green-500 mr-2"></i> Giải đáp thắc mắc & hỗ trợ trực tiếp
                    </li>
                  </ul>
                  <div className="mt-3 bg-green-50 p-2 rounded-lg text-xs text-green-700">
              ...
              <div className="timeline-item">
                <div className="timeline-point"></div>
                <div className="timeline-content">
                  <div className="phase-pill bg-indigo-100 text-indigo-700">Giai đoạn 4 • Tuần 6-8</div>
                  <h3 className="text-lg font-bold text-gray-800 mb-2 flex items-center">
                  ...
                  <div className="mt-3 bg-indigo-50 p-2 rounded-lg text-xs text-indigo-700">
          ...
          <div className="w-1/5 flex flex-col space-y-4">
            <div className="quick-facts text-white">
              ...
              <div className="flex items-center mb-3">
                ...
                <div>
                  <div className="text-xs opacity-80">Tổng thời gian</div>
                  <div className="text-xl font-bold">8 tuần</div>
                </div>
              </div>
              <div className="h-px bg-white bg-opacity-20 my-3"></div>
              <div className="text-sm font-semibold mb-1">Nâng cấp liên tục</div>
              <div className="text-xs opacity-80">Cập nhật tính năng mới mỗi quý</div>
            </div>

            <div className="bg-white p-4 rounded-lg shadow-md">
              <h3 className="font-bold text-gray-800 text-lg mb-4">Yêu cầu chuẩn bị</h3>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
              <div className="font-semibold text-blue-700 mb-2">Cam kết hỗ trợ</div>
